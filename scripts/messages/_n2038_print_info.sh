...
__N2038_PATH_TO_THIS_SCRIPT_FROM_ENVIRONMENT_ROOT="scripts/messages/_n2038_print_info.sh"
...
#
# Usage: _n2038_print_info [text]
_n2038_print_info() {
  _n2038_print_color_message "${c_info}" "${@}" >&2 || return "$?"
  return 0
}
