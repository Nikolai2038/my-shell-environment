...
__N2038_PATH_TO_THIS_SCRIPT_FROM_ENVIRONMENT_ROOT="scripts/programs/firefox/n2038_firefox_get_profile_path.sh"
...
__N2038_FIREFOX_TYPE_FIREFOX="firefox"
__N2038_FIREFOX_TYPE_FIREFOX_DEVELOPER_EDITION="firefox-developer-edition"

# Prints the path to the Firefox profile.
#
# Usage: n2038_firefox_get_profile_path <firefox_type>
# Where:
# - `firefox_type`:
#   - `firefox`: Firefox;
#   - `firefox-developer-edition`: Firefox for Developers.
n2038_firefox_get_profile_path() {
  __n2038_usage() {
    _n2038_print_error "Usage: ${c_highlight}n2038_firefox_get_profile_path <${__N2038_FIREFOX_TYPE_FIREFOX}|${__N2038_FIREFOX_TYPE_FIREFOX_DEVELOPER_EDITION}>${c_return}" || { _n2038_unset "$?" && return "$?" || return "$?"; }
  ...
  if [ "${__n2038_firefox_type}" = "${__N2038_FIREFOX_TYPE_FIREFOX}" ]; then
  ...
  elif [ "${__n2038_firefox_type}" = "${__N2038_FIREFOX_TYPE_FIREFOX_DEVELOPER_EDITION}" ]; then
